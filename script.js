...
// - rating, which is a String representing the rating of the movie (i.e. sk­13, R, etc)

// a) Write a constructor for the class Movie, which takes a String representing the title of the movie, 
//    a String representing the studio, and a String representing the rating as its arguments, 
//    and sets the respective class properties to these values.

// b) The constructor for the class Movie will set the class property rating to "sk" as default when no rating is provided.

// c) Write a method getPG, which takes an array of base type Movie as its argument, and returns a new array of only those movies in the input array with a rating of "sk".
//    You may assume the input array is full of Movie instances. The returned array need not be full.

// d) Write a piece of code that creates an instance of the class Movie with the title “Casino Royale”, the studio “Eon Productions”, and the rating “sk­13”
...
class Movie {
    ...
    constructor (title, studio, rating) {
      ...
      getPG(array){
        ...
        var result = array.filter((element)=> element.rating =="sk")
        return result
  }

}

  let movie1 = new Movie ("AK","seven studios","sk13");
  let movie2 = new Movie ("Esan","redgiant studios","sk1");
  let movie3 = new Movie ("A","harry studios");
  let movie4 = new Movie ("B","sk studios");
  ...
  let movie5 = new Movie ("Casino Royale","smart Productions","sk13")
...
var res1=new person("harrysmart","k","male",25,"harikarthik508@gmail.com")
  var res2=new person("indrajith","v","male",26,"indicube32@gmail.com")
